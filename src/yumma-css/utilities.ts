...
export const utilities = [
    ...
    },
    {
        ...
        additionalClasses: [
            ...
            { classSuffix: 'auto', classValues: ['max-height: auto;', 'min-width: auto;'] },
            { classSuffix: 'full', classValues: ['max-height: 100%;', 'min-width: 100%;'] },
            { classSuffix: 'half', classValues: ['max-height: 50%;', 'min-width: 50%;'] },
            { classSuffix: 'fc', classValues: ['max-height: fit-content;', 'min-width: fit-content;'] },
            { classSuffix: '1/1', classValues: ['max-height: 100dvh;', 'min-width: 100dvh;'] },
            { classSuffix: '1/2', classValues: ['max-height: 50dvh;', 'min-width: 50dvh;'] }
        ]
    },
    {
        classPrefix: 'min-dim-',
        ...
        additionalClasses: [
            ...
            { classSuffix: 'auto', classValues: ['min-height: auto;', 'min-width: auto;'] },
            { classSuffix: 'full', classValues: ['min-height: 100%;', 'min-width: 100%;'] },
            { classSuffix: 'half', classValues: ['min-height: 50%;', 'min-width: 50%;'] },
            { classSuffix: 'fc', classValues: ['min-height: fit-content;', 'min-width: fit-content;'] },
            { classSuffix: '1/1', classValues: ['min-height: 100dvh;', 'min-width: 100dvh;'] },
            { classSuffix: '1/2', classValues: ['min-height: 50dvh;', 'min-width: 50dvh;'] }
        ]
    },
    {
        classPrefix: 'h-',
    ...
    },
    {
        ...
        additionalClasses: [
            { classSuffix: '1', classValues: ['grid-template-columns: repeat(1, minmax(0, 1fr));'] },
            { classSuffix: '2', classValues: ['grid-template-columns: repeat(2, minmax(0, 1fr));'] },
            { classSuffix: '3', classValues: ['grid-template-columns: repeat(3, minmax(0, 1fr));'] },
            { classSuffix: '4', classValues: ['grid-template-columns: repeat(4, minmax(0, 1fr));'] },
            { classSuffix: '5', classValues: ['grid-template-columns: repeat(5, minmax(0, 1fr));'] },
            { classSuffix: '6', classValues: ['grid-template-columns: repeat(6, minmax(0, 1fr));'] },
            { classSuffix: '7', classValues: ['grid-template-columns: repeat(7, minmax(0, 1fr));'] },
            { classSuffix: '8', classValues: ['grid-template-columns: repeat(8, minmax(0, 1fr));'] },
            { classSuffix: '9', classValues: ['grid-template-columns: repeat(9, minmax(0, 1fr));'] },
            { classSuffix: '10', classValues: ['grid-template-columns: repeat(10, minmax(0, 1fr));'] },
            { classSuffix: '11', classValues: ['grid-template-columns: repeat(11, minmax(0, 1fr));'] }
        ]
    },
    {
        classPrefix: 'gtr-',
        ...
        additionalClasses: [
            { classSuffix: '1', classValues: ['grid-template-rows: repeat(1, minmax(0, 1fr));'] },
            { classSuffix: '2', classValues: ['grid-template-rows: repeat(2, minmax(0, 1fr));'] },
            { classSuffix: '3', classValues: ['grid-template-rows: repeat(3, minmax(0, 1fr));'] },
            { classSuffix: '4', classValues: ['grid-template-rows: repeat(4, minmax(0, 1fr));'] },
            { classSuffix: '5', classValues: ['grid-template-rows: repeat(5, minmax(0, 1fr));'] },
            { classSuffix: '6', classValues: ['grid-template-rows: repeat(6, minmax(0, 1fr));'] },
            { classSuffix: '7', classValues: ['grid-template-rows: repeat(7, minmax(0, 1fr));'] },
            { classSuffix: '8', classValues: ['grid-template-rows: repeat(8, minmax(0, 1fr));'] },
            { classSuffix: '9', classValues: ['grid-template-rows: repeat(9, minmax(0, 1fr));'] },
            { classSuffix: '10', classValues: ['grid-template-rows: repeat(10, minmax(0, 1fr));'] },
            { classSuffix: '11', classValues: ['grid-template-rows: repeat(11, minmax(0, 1fr));'] },
            { classSuffix: '12', classValues: ['grid-template-rows: repeat(12, minmax(0, 1fr));'] },
            { classSuffix: '13', classValues: ['grid-template-rows: repeat(13, minmax(0, 1fr));'] },
            { classSuffix: '14', classValues: ['grid-template-rows: repeat(14, minmax(0, 1fr));'] },
            { classSuffix: '15', classValues: ['grid-template-rows: repeat(15, minmax(0, 1fr));'] },
            { classSuffix: '16', classValues: ['grid-template-rows: repeat(16, minmax(0, 1fr));'] }
        ]
    },
    {
        classPrefix: 'ac-',
    ...
    },
    {
        ...
        classLink: 'container',
        additionalClasses: [
            { classSuffix: '', classValues: ['width: 100%;'] }
        ]
    },
    {
        classPrefix: 'dir-b-',
    ...
    },
    {
        ...
        classLink: 'inset',
        additionalClasses: [
            { classSuffix: '', classValues: ['align-items: center;', 'display: flex;', 'justify-content: center;'] }
        ]
    },
    {
        classPrefix: 'of-',
    ...
    // typography
    {
        ...
        additionalClasses: [
            { classSuffix: 'c', classValues: ['font-family: Charter, Cambria, serif;'] },
            { classSuffix: 'm', classValues: ['font-family: ui-monospace, Consolas, monospace;'] },
            { classSuffix: 's', classValues: ['font-family: system-ui, sans-serif;'] }
        ]
    },
    {
        classPrefix: 'fs-',
    ...
    },
    {
        ...
        additionalClasses: [
            ...
            { classSuffix: 'lt', classValues: ['text-decoration-line: line-through;'] }
        ]
    },
    {
        classPrefix: 'tds-',
    ...
    },
    {
        ...
        additionalClasses: [
            { classSuffix: 'auto', classValues: ['text-decoration-thickness: auto;'] },
            { classSuffix: 'ff', classValues: ['text-decoration-thickness: from-font;'] },
